...
<div className='flex flex-col lg:flex-row  justify-center items-center  mt-20 lg:mt-[100px] gap-14 pb-20 lg:pb-24'>
    <div className='bg-[#E8E6FE] relative w-[290px] lg:w-[320px]  h-[320px] rounded flex flex-col justify-center p-2 ps-3 gap-4'>
        ...
        <img className='absolute opacity-30  object-cover' src={bg} alt="" />
    </div>
    <div className='bg-[#AFEBE3] w-[290px] lg:w-[320px] h-[320px] rounded flex flex-col justify-center p-2 ps-3 gap-6 relative'>
    ...
    <div className='bg-[#FFDEE9] w-[290px] lg:w-[320px] h-[320px] rounded flex flex-col justify-center p-2 ps-3 gap-4 relative'>
