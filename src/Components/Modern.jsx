...
function Modern() {
  return (
    <div className='bg-[#FFF5EB]'>
        <h1 className='lg:text-4xl text-2xl font-semibold lg:w-[450px] mx-auto  text-center pt-10'>About Us</h1>
...
<div className='flex flex-col lg:flex-row  justify-center items-center  mt-20 lg:mt-[100px] gap-14 pb-20 lg:pb-24'>
    <div className='bg-[#E8E6FE] w-[290px] lg:w-[320px]  h-[220px] rounded flex flex-col justify-center p-2 ps-3 gap-4'>
        ...
        <p className='text-gray-900'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis optio mollitia at illum itaque ut architecto illo placeat saepe provident.</p>
        <div>
